...
public class DropDownHandler3 : MonoBehaviour
{
    ...
    **/
    ...
    public GameObject GlobalListParent;
    ...
    private void AddItemToList(string file)
    {
        ...
        GameObject NewListItem = Instantiate(ListItem, this.transform.GetChild(0));
        ...
        var ItemToggle = ListItem.transform.GetChild(2);
        Toggle ItemToggleComponent = (Toggle)ItemToggle.GetComponent<Toggle>();     
        
        /*
        ItemToggleComponent.onValueChanged.AddListener(delegate {            
            ToggleValueChanged(ItemToggleComponent);
        });
        */
